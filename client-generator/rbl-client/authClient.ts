...
export function useGetCurrentUser(
  ...
  options?: Omit<UseQueryOptions<GetCurrentUserResponse>, 'queryKey' | 'queryFn'>
) {
  return useQuery({
...
export function useLogin(
  options?: UseMutationOptions<LoginResponse, Error, { data: any }>
) {
  return useMutation({
...
export function useValidateToken(
  options?: UseMutationOptions<ValidateTokenResponse, Error, { data: any }>
) {
  return useMutation({
    mutationFn: async (variables: { data: any }) => {
...
export function useRefreshToken(
  options?: UseMutationOptions<RefreshTokenResponse, Error, { data: any }>
) {
  return useMutation({
    mutationFn: async (variables: { data: any }) => {
...
export function useCheckPermission(
  options?: UseMutationOptions<CheckPermissionResponse, Error, { data: any }>
) {
  return useMutation({
    mutationFn: async (variables: { data: any }) => {
...
export function useLogout(
  options?: UseMutationOptions<LogoutResponse, Error, { data: any }>
) {
  return useMutation({
    mutationFn: async (variables: { data: any }) => {
