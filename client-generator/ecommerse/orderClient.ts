...
export function useGetOrder(
  ...
  options?: Omit<UseQueryOptions<Types.GetOrderResponse>, 'queryKey' | 'queryFn'>
) {
  return useQuery({
...
export function useGetUserOrders(
  ...
  options?: Omit<UseQueryOptions<Types.GetUserOrdersResponse>, 'queryKey' | 'queryFn'>
) {
  return useQuery({
...
export function useGetOrdersByStatus(
  ...
  options?: Omit<UseQueryOptions<Types.GetOrdersByStatusResponse>, 'queryKey' | 'queryFn'>
) {
  return useQuery({
...
export function useCreateOrder(
  options?: UseMutationOptions<Types.CreateOrderResponse, Error, { data: any }>
) {
  return useMutation({
...
export function useUpdateOrder(
  options?: UseMutationOptions<Types.UpdateOrderResponse, Error, { id: string; data: any }>
) {
  return useMutation({
...
export function useDeleteOrder(
  options?: UseMutationOptions<Types.DeleteOrderResponse, Error, { id: string }>
) {
  return useMutation({
...
export function useConfirmOrder(
  options?: UseMutationOptions<Types.ConfirmOrderResponse, Error, { id: string; data: any }>
) {
  return useMutation({
    mutationFn: async (variables: { id: string; data: any }) => {
      const id = variables.id;
...
export function useCancelOrder(
  options?: UseMutationOptions<Types.CancelOrderResponse, Error, { id: string; data: any }>
) {
  return useMutation({
    mutationFn: async (variables: { id: string; data: any }) => {
      const id = variables.id;
